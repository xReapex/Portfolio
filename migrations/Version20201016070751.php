 ...
 */
final class Version20201016070751 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE feedbacks (id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, author VARCHAR(100) DEFAULT NULL, date DATE DEFAULT NULL, PRIMARY KEY(id))');
