...
require __DIR__.'/ContainerI9SHz70/App_KernelDevDebugContainer.php';
require __DIR__.'/ContainerI9SHz70/getWebpackEncore_TagRendererService.php';
require __DIR__.'/ContainerI9SHz70/getWebpackEncore_ExceptionListenerService.php';
require __DIR__.'/ContainerI9SHz70/getWebpackEncore_EntrypointLookupCollectionService.php';
require __DIR__.'/ContainerI9SHz70/getWebpackEncore_EntrypointLookupDefaultService.php';
require __DIR__.'/ContainerI9SHz70/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerI9SHz70/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerI9SHz70/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerI9SHz70/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerI9SHz70/getValidator_ExpressionService.php';
require __DIR__.'/ContainerI9SHz70/getValidator_EmailService.php';
require __DIR__.'/ContainerI9SHz70/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerI9SHz70/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerI9SHz70/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerI9SHz70/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerI9SHz70/getSwiftmailer_TransportService.php';
require __DIR__.'/ContainerI9SHz70/getSwiftmailer_Mailer_Default_Transport_RealService.php';
require __DIR__.'/ContainerI9SHz70/getSwiftmailer_Mailer_Default_Plugin_MessageloggerService.php';
require __DIR__.'/ContainerI9SHz70/getSwiftmailer_Mailer_DefaultService.php';
require __DIR__.'/ContainerI9SHz70/getSwiftmailer_EmailSender_ListenerService.php';
require __DIR__.'/ContainerI9SHz70/getSession_Storage_NativeService.php';
require __DIR__.'/ContainerI9SHz70/getSessionService.php';
require __DIR__.'/ContainerI9SHz70/getServicesResetterService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_PasswordEncoderService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_Csrf_TokenManagerService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_ContextListener_0Service.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_Authentication_Listener_Anonymous_MainService.php';
require __DIR__.'/ContainerI9SHz70/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerI9SHz70/getSecrets_VaultService.php';
require __DIR__.'/ContainerI9SHz70/getRouting_LoaderService.php';
require __DIR__.'/ContainerI9SHz70/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerI9SHz70/getMonolog_Logger_SecurityService.php';
require __DIR__.'/ContainerI9SHz70/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerI9SHz70/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerI9SHz70/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerI9SHz70/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerI9SHz70/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerI9SHz70/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerI9SHz70/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerI9SHz70/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerI9SHz70/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerI9SHz70/getForm_Type_FormService.php';
require __DIR__.'/ContainerI9SHz70/getForm_Type_FileService.php';
require __DIR__.'/ContainerI9SHz70/getForm_Type_EntityService.php';
require __DIR__.'/ContainerI9SHz70/getForm_Type_ColorService.php';
require __DIR__.'/ContainerI9SHz70/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerI9SHz70/getForm_ServerParamsService.php';
require __DIR__.'/ContainerI9SHz70/getForm_RegistryService.php';
require __DIR__.'/ContainerI9SHz70/getForm_FactoryService.php';
require __DIR__.'/ContainerI9SHz70/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerI9SHz70/getFilesystemService.php';
require __DIR__.'/ContainerI9SHz70/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerI9SHz70/getErrorControllerService.php';
require __DIR__.'/ContainerI9SHz70/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerI9SHz70/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerI9SHz70/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerI9SHz70/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerI9SHz70/getContainer_GetenvService.php';
require __DIR__.'/ContainerI9SHz70/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerI9SHz70/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerI9SHz70/getCacheClearerService.php';
require __DIR__.'/ContainerI9SHz70/getCache_SystemClearerService.php';
require __DIR__.'/ContainerI9SHz70/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerI9SHz70/getCache_AppClearerService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Swagger_Action_UiService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Doctrine_Orm_QueryExtension_OrderService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Doctrine_Orm_Default_SubresourceDataProviderService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Doctrine_Orm_DataPersisterService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerI9SHz70/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerI9SHz70/getAnnotations_CacheService.php';
require __DIR__.'/ContainerI9SHz70/getTemplateControllerService.php';
require __DIR__.'/ContainerI9SHz70/getRedirectControllerService.php';
require __DIR__.'/ContainerI9SHz70/getProjectManagerService.php';
require __DIR__.'/ContainerI9SHz70/getProjectIdService.php';
require __DIR__.'/ContainerI9SHz70/getNewsletterRepositoryService.php';
require __DIR__.'/ContainerI9SHz70/getFeedbacksRepositoryService.php';
require __DIR__.'/ContainerI9SHz70/getProjectControllerService.php';
require __DIR__.'/ContainerI9SHz70/getHomeControllerService.php';
require __DIR__.'/ContainerI9SHz70/getFeedbacksControllerService.php';
require __DIR__.'/ContainerI9SHz70/getApiControllerService.php';
require __DIR__.'/ContainerI9SHz70/getAboutControllerService.php';
require __DIR__.'/ContainerI9SHz70/get_ServiceLocator_G9CqTPpService.php';
require __DIR__.'/ContainerI9SHz70/get_ServiceLocator_Beq5mCoService.php';
require __DIR__.'/ContainerI9SHz70/get_ServiceLocator_SAesO7cService.php';
require __DIR__.'/ContainerI9SHz70/get_ServiceLocator_C9JCBPCService.php';
require __DIR__.'/ContainerI9SHz70/get_ServiceLocator_5pDFwFyService.php';
require __DIR__.'/ContainerI9SHz70/get_ServiceLocator__Ye3FAmService.php';
require __DIR__.'/ContainerI9SHz70/get_ServiceLocator__SHG4GCService.php';
...
$classes[] = 'App\Controller\feedbacks\FeedbacksController';
$classes[] = 'App\Controller\home\HomeController';
$classes[] = 'App\Services\TokenGenerator';
$classes[] = 'App\Controller\project\ProjectController';
$classes[] = 'App\Repository\FeedbacksRepository';
$classes[] = 'App\Repository\NewsletterRepository';
$classes[] = 'App\Services\ProjectId';
$classes[] = 'App\Services\ProjectManager';
